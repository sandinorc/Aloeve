...
migrate((app) => {
  ...
  const collection = new Collection({
    ...
    "indexes": [],
    "listRule": "",
    "name": "historial_sesiones_cliente",
    "system": false,
    "type": "base",
    "updateRule": "",
    "viewRule": ""
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_9305792523");
